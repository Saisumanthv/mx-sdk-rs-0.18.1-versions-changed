...
pub trait DctNftMarketplace: storage::StorageModule + views::ViewsModule {
    #[init]
    ...
    fn auction_token(
        ...
        require!(
            accepted_payment_token.is_moax() || accepted_payment_token.is_valid_dct_identifier(),
    ...
    fn withdraw(&self, auction_id: u64) -> SCResult<()> {
        ...
        self.transfer_dct(&caller, nft_type, nft_nonce, nft_amount, b"returned token");
