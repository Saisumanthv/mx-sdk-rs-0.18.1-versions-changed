...
mod call_async {
    ...
    use dharitri_wasm::api::{ErrorApi, LogApi};
    ...
    impl<BigUint: BigUintApi> dharitri_codec::TopEncode for CallbackData<BigUint> {
        fn top_encode<O: dharitri_codec::TopEncodeOutput>(
            &self,
            output: O,
        ) -> core::result::Result<(), dharitri_codec::EncodeError> {
            let mut buffer = dharitri_codec::Vec::<u8>::new();
            let dest = &mut buffer;
            dharitri_codec::NestedEncode::dep_encode(&self.callback_name, dest)?;
            dharitri_codec::NestedEncode::dep_encode(&self.token_identifier, dest)?;
            dharitri_codec::NestedEncode::dep_encode(&self.token_nonce, dest)?;
            dharitri_codec::NestedEncode::dep_encode(&self.token_amount, dest)?;
            dharitri_codec::NestedEncode::dep_encode(&self.args, dest)?;
            output.set_slice_u8(&buffer[..]);
            core::result::Result::Ok(())
        }
        fn top_encode_or_exit<O: dharitri_codec::TopEncodeOutput, ExitCtx: Clone>(
            &self,
            output: O,
            c: ExitCtx,
            exit: fn(ExitCtx, dharitri_codec::EncodeError) -> !,
        ) {
            let mut buffer = dharitri_codec::Vec::<u8>::new();
            let dest = &mut buffer;
            dharitri_codec::NestedEncode::dep_encode_or_exit(
                &self.callback_name,
                dest,
                c.clone(),
                exit,
            ...
            dharitri_codec::NestedEncode::dep_encode_or_exit(&self.args, dest, c.clone(), exit);
            output.set_slice_u8(&buffer[..]);
        }
    }
    impl<BigUint: BigUintApi> dharitri_codec::TopDecode for CallbackData<BigUint> {
        fn top_decode<I: dharitri_codec::TopDecodeInput>(
            top_input: I,
        ) -> core::result::Result<Self, dharitri_codec::DecodeError> {
            let bytes = top_input.into_boxed_slice_u8();
            let input = &mut &*bytes;
            let result = CallbackData {
                callback_name: <BoxedBytes as dharitri_codec::NestedDecode>::dep_decode(input)?,
                token_identifier: <TokenIdentifier as dharitri_codec::NestedDecode>::dep_decode(
                    input,
                )?,
                token_nonce: <u64 as dharitri_codec::NestedDecode>::dep_decode(input)?,
                token_amount: <BigUint as dharitri_codec::NestedDecode>::dep_decode(input)?,
                args: <Vec<BoxedBytes> as dharitri_codec::NestedDecode>::dep_decode(input)?,
            };
            if !input.is_empty() {
                return core::result::Result::Err(dharitri_codec::DecodeError::INPUT_TOO_LONG);
            }
            core::result::Result::Ok(result)
        }
        fn top_decode_or_exit<I: dharitri_codec::TopDecodeInput, ExitCtx: Clone>(
            top_input: I,
            c: ExitCtx,
            exit: fn(ExitCtx, dharitri_codec::DecodeError) -> !,
        ) -> Self {
            let bytes = top_input.into_boxed_slice_u8();
            let input = &mut &*bytes;
            let result = CallbackData {
                callback_name: <BoxedBytes as dharitri_codec::NestedDecode>::dep_decode_or_exit(
                    input,
                    c.clone(),
                    exit,
                ),
                token_identifier:
                    <TokenIdentifier as dharitri_codec::NestedDecode>::dep_decode_or_exit(
                        input,
                        c.clone(),
                        exit,
                    ),
                token_nonce: <u64 as dharitri_codec::NestedDecode>::dep_decode_or_exit(
                    input,
                    c.clone(),
                    exit,
                ),
                token_amount: <BigUint as dharitri_codec::NestedDecode>::dep_decode_or_exit(
                    input,
                    c.clone(),
                    exit,
                ),
                args: <Vec<BoxedBytes> as dharitri_codec::NestedDecode>::dep_decode_or_exit(
                    input,
                    c.clone(),
                    exit,
                ),
            ...
            if !input.is_empty() {
                exit(c, dharitri_codec::DecodeError::INPUT_TOO_LONG);
            }
            result
        }
    }
    impl<BigUint: BigUintApi> dharitri_wasm::abi::TypeAbi for CallbackData<BigUint> {
        fn type_name() -> dharitri_wasm::String {
            "CallbackData".into()
        }
        fn provide_type_descriptions<TDC: dharitri_wasm::abi::TypeDescriptionContainer>(
            ...
            if !accumulator.contains_type(&type_name) {
                ...
                let mut field_descriptions = dharitri_wasm::Vec::new();
    ...
    pub trait ForwarderAsyncCallModule: dharitri_wasm::api::ContractBase + Sized
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        ...
        C: AutoImpl,
    {
        ...
        fn callback_data(&self) -> VecMapper<Self::Storage, CallbackData<Self::BigUint>> {
            ...
            < VecMapper < Self :: Storage , CallbackData < Self :: BigUint > > as dharitri_wasm :: storage :: mappers :: StorageMapper < Self :: Storage > > :: new (self . get_storage_raw () , dharitri_wasm :: types :: BoxedBytes :: from (key))
        }
        fn callbacks(&self) -> self::CallbackProxyObj<Self::SendApi> {
    ...
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + ForwarderAsyncCallModule
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_forward_async_accept_funds(&self) {
            ...
            let token_nonce = self.call_value().dct_token_nonce();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
            let to = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
            );
        ...
        fn call_forward_async_retrieve_funds(&self) {
            ...
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 4i32);
            let to = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
            );
            let token = dharitri_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
                1i32,
                ArgId::from(&b"token"[..]),
            );
            let token_nonce = dharitri_wasm::load_single_arg::<Self::ArgumentApi, u64>(
                self.argument_api(),
                2i32,
                ArgId::from(&b"token_nonce"[..]),
            );
            let amount = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Self::BigUint>(
                self.argument_api(),
                3i32,
                ArgId::from(&b"amount"[..]),
            );
        ...
        fn call_send_funds_twice(&self) {
            self.call_value().check_not_payable();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
            let to = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
            );
            let token_identifier = dharitri_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
                1i32,
        ...
        fn call_callback_data_at_index(&self) {
            self.call_value().check_not_payable();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
            let index = dharitri_wasm::load_single_arg::<Self::ArgumentApi, usize>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"index"[..]),
            );
        ...
        fn callback_selector<'a>(
            &self,
            mut ___cb_data_deserializer___: dharitri_wasm::hex_call_data::HexCallDataDeserializer<'a>,
        ) -> dharitri_wasm::types::CallbackSelectorResult<'a> {
            ...
            match ___cb_data_deserializer___.get_func_name() {
                ...
                [115u8, 101u8, 110u8, 100u8, 95u8, 102u8, 117u8, 110u8, 100u8, 115u8, 95u8, 116u8, 119u8, 105u8, 99u8, 101u8, 95u8, 99u8, 97u8, 108u8, 108u8, 98u8, 97u8, 99u8, 107u8] =>
                {
                    let mut ___cb_closure_loader___ =
                        CallDataArgLoader::new(___cb_data_deserializer___, self.error_api());
                    let to: &Address = &dharitri_wasm::load_dyn_arg(
                        &mut ___cb_closure_loader___,
                        ArgId::from(&b"to"[..]),
                    );
                    let token_identifier: &TokenIdentifier = &dharitri_wasm::load_dyn_arg(
                        &mut ___cb_closure_loader___,
                        ArgId::from(&b"token_identifier"[..]),
                    );
                    let cb_amount: &Self::BigUint = &dharitri_wasm::load_dyn_arg(
                        &mut ___cb_closure_loader___,
            ...
            dharitri_wasm::types::CallbackSelectorResult::NotProcessed(___cb_data_deserializer___)
        }
        fn callback(&self) {
            let ___tx_hash___ = dharitri_wasm::api::BlockchainApi::get_tx_hash(&self.blockchain());
            let ___cb_data_raw___ = dharitri_wasm::api::StorageReadApi::storage_load_boxed_bytes(
                &self.get_storage_raw(),
                &___tx_hash___.as_bytes(),
            );
            dharitri_wasm::api::StorageWriteApi::storage_store_slice_u8(
                &self.get_storage_raw(),
                &___tx_hash___.as_bytes(),
                &[],
            );
            let mut ___cb_data_deserializer___ =
                dharitri_wasm::hex_call_data::HexCallDataDeserializer::new(
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderAsyncCallModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
    ...
    where
        A::BigUint: dharitri_wasm::api::BigUintApi,
        ...
        A::BigInt: dharitri_wasm::api::BigIntApi,
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized {
        ...
        fn forward_async_accept_funds(
            ...
            Self::SendApi,
            <AsyncCall<Self::SendApi> as dharitri_wasm::io::EndpointResult>::DecodeAs,
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                payment,
                token_nonce,
                dharitri_wasm::types::BoxedBytes::from(&b"forward_async_accept_funds"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                payment,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"forward_async_retrieve_funds"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"send_funds_twice"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        #[allow(clippy::too_many_arguments)]        fn callback_data (self) -> dharitri_wasm :: types :: ContractCall < Self :: SendApi , < VecMapper < Self :: Storage , CallbackData < Self :: BigUint > > as dharitri_wasm :: io :: EndpointResult > :: DecodeAs >{
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ___api___.clone(),
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"callback_data"[..]),
            );
            ___contract_call___
        }
        #[allow(clippy::too_many_arguments)]
        fn callback_data_at_index(
            ...
            <MultiResult5<
                ...
                Self::BigUint,
                MultiResultVec<BoxedBytes>,
            > as dharitri_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"callback_data_at_index"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                index,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"clear_callback_data"[..]),
            );
            ___contract_call___
        }
    }
    ...
    pub trait CallbackProxy: dharitri_wasm::api::CallbackProxyObjApi + Sized {
        fn retrieve_funds_callback(self) -> dharitri_wasm::types::CallbackCall {
        ...
        fn send_funds_twice_callback(
            ...
            token_identifier: &TokenIdentifier,
            cb_amount: &Self::BigUint,
        ) -> dharitri_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = dharitri_wasm::types::ArgBuffer::new();
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
...
mod call_sync {
    ...
    use dharitri_wasm::{Box, Vec};
    use vault::ProxyTrait as _;
    pub trait ForwarderSyncCallModule: dharitri_wasm::api::ContractBase + Sized
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        C: AutoImpl,
    {
        ...
        fn execute_on_dest_context_result_event(&self, result: &[BoxedBytes]) {
            ...
            let ___data_bytes___ =
                dharitri_wasm::log_util::serialize_log_data(result, self.log_api_raw());
            self.log_api_raw()
    ...
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + ForwarderSyncCallModule
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_echo_arguments_sync(&self) {
            ...
            let to: Address =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
            let args: VarArgs<BoxedBytes> =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"args"[..]));
        ...
        fn call_echo_arguments_sync_range(&self) {
            ...
            let to: Address =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
            let start: usize =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"start"[..]));
            let end: usize =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"end"[..]));
            let args: VarArgs<BoxedBytes> =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"args"[..]));
            ___arg_loader.assert_no_more_args();
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderSyncCallModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized {
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"echo_arguments_sync"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"echo_arguments_sync_range"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"echo_arguments_sync_twice"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                payment,
                token_nonce,
                dharitri_wasm::types::BoxedBytes::from(&b"forward_sync_accept_funds"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        fn forward_sync_accept_funds_then_read(
            ...
            Self::SendApi,
            <usize as dharitri_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                payment,
                token_nonce,
                dharitri_wasm::types::BoxedBytes::from(&b"forward_sync_accept_funds_then_read"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"forward_sync_retrieve_funds"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
...
mod call_transf_exec {
    ...
    use dharitri_wasm::{Box, Vec};
    use vault::ProxyTrait as _;
    pub trait ForwarderTransferExecuteModule: dharitri_wasm::api::ContractBase + Sized
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + ForwarderTransferExecuteModule
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderTransferExecuteModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized {
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                payment,
                token_nonce,
                dharitri_wasm::types::BoxedBytes::from(&b"forward_transf_exec_accept_funds"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        #[allow(clippy::too_many_arguments)]        fn forward_transf_exec_accept_funds_return_values (self , to : Address , token : TokenIdentifier , payment : Self :: BigUint , token_nonce : u64) -> dharitri_wasm :: types :: ContractCall < Self :: SendApi , < MultiResult4 < u64 , u64 , Self :: BigUint , TokenIdentifier > as dharitri_wasm :: io :: EndpointResult > :: DecodeAs >{
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ___api___.clone(),
...
mod contract_change_owner {
    ...
    use dharitri_wasm::{Box, Vec};
    use vault::ProxyTrait as _;
    pub trait ChangeOwnerModule: dharitri_wasm::api::ContractBase + Sized
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers: dharitri_wasm::api::ContractPrivateApi + ChangeOwnerModule
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_change_owner(&self) {
            self.call_value().check_not_payable();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 2i32);
            let child_sc_address = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"child_sc_address"[..]),
            );
            let new_owner = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                1i32,
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "ChangeOwnerModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized {
        ...
        fn change_owner(
            ...
            Self::SendApi,
            <Address as dharitri_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"changeOwnerAddress"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                child_sc_address,
                ___contract_call___.get_mut_arg_buffer(),
...
mod contract_deploy {
    ...
    use dharitri_wasm::{Box, Vec};
    use vault::ProxyTrait as _;
    pub trait DeployContractModule: dharitri_wasm::api::ContractBase + Sized
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + DeployContractModule
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_deploy_contract(&self) {
            self.call_value().check_not_payable();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
            let code = dharitri_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"code"[..]),
            );
        ...
        fn call_deploy_from_source(&self) {
            self.call_value().check_not_payable();
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let source_contract_address: Address = dharitri_wasm::load_dyn_arg(
                &mut ___arg_loader,
                ArgId::from(&b"source_contract_address"[..]),
            );
            let arguments: VarArgs<BoxedBytes> =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"arguments"[..]));
            ___arg_loader.assert_no_more_args();
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "DeployContractModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized {
        ...
        fn deploy_contract(
            ...
            Self::SendApi,
            <SCResult<Address> as dharitri_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"deploy_contract"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                code,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"deployFromSource"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                source_contract_address,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        fn deploy_two_contracts(
            ...
            Self::SendApi,
            <SCResult<MultiResult2<Address, Address>> as dharitri_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"deploy_two_contracts"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                code,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        fn deploy_vault(
            ...
            Self::SendApi,
            <Option<Address> as dharitri_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"deploy_vault"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                code,
                ___contract_call___.get_mut_arg_buffer(),
...
mod contract_update {
    ...
    use dharitri_wasm::{non_zero_usize, only_owner, require, sc_error};
    use dharitri_wasm::{Box, Vec};
    pub trait UpgradeContractModule: dharitri_wasm::api::ContractBase + Sized
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + UpgradeContractModule
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_upgrade_child_contract(&self) {
            self.call_value().check_not_payable();
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let child_sc_address: Address = dharitri_wasm::load_dyn_arg(
                &mut ___arg_loader,
                ArgId::from(&b"child_sc_address"[..]),
            );
            let new_code: BoxedBytes =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"new_code"[..]));
            let arguments: VarArgs<BoxedBytes> =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"arguments"[..]));
            ___arg_loader.assert_no_more_args();
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "UpgradeContractModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized {
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"upgradeChildContract"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                child_sc_address,
                ___contract_call___.get_mut_arg_buffer(),
...
mod dct {
    ...
    pub trait ForwarderDctModule:
        dharitri_wasm::api::ContractBase + Sized + storage::ForwarderStorageModule
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait AutoImpl: dharitri_wasm::api::ContractBase {}
    impl<C> ForwarderDctModule for C
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + ForwarderDctModule + storage::EndpointWrappers
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    {
        #[inline]
        fn call_get_fungible_dct_balance(&self) {
            self.call_value().check_not_payable();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 1i32);
            let token_identifier = dharitri_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
            ...
            let result = self.get_fungible_dct_balance(&token_identifier);
            dharitri_wasm::io::EndpointResult::finish(&result, self.finish_api());
        }
        #[inline]
        fn call_send_dct(&self) {
            self.call_value().check_not_payable();
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let to: &Address =
                &dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
            let token_id: TokenIdentifier =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"token_id"[..]));
            let amount: &Self::BigUint =
                &dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"amount"[..]));
            let opt_data: OptionalArg<BoxedBytes> =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"opt_data"[..]));
            ___arg_loader.assert_no_more_args();
            self.send_dct(&to, token_id, &amount, opt_data);
        }
        #[inline]
        fn call_send_dct_twice(&self) {
            self.call_value().check_not_payable();
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let to: &Address =
                &dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
            let token_id: TokenIdentifier =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"token_id"[..]));
            let amount_first_time: &Self::BigUint = &dharitri_wasm::load_dyn_arg(
                &mut ___arg_loader,
                ArgId::from(&b"amount_first_time"[..]),
            );
            let amount_second_time: &Self::BigUint = &dharitri_wasm::load_dyn_arg(
                &mut ___arg_loader,
        ...
        fn call_issue_fungible_token(&self) {
            let issue_cost = self.call_value().require_moax();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
            let token_display_name = dharitri_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"token_display_name"[..]),
            );
            let token_ticker = dharitri_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                1i32,
                ArgId::from(&b"token_ticker"[..]),
            );
            let initial_supply = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Self::BigUint>(
                self.argument_api(),
                2i32,
        ...
        fn call(&self, fn_name: &[u8]) -> bool {
            if match fn_name {
                ...
                {
                    self.call_get_fungible_dct_balance();
                    true
                }
        ...
        fn callback_selector<'a>(
            ...
            match ___cb_data_deserializer___.get_func_name() {
                ...
                [101u8, 115u8, 100u8, 116u8, 95u8, 105u8, 115u8, 115u8, 117u8, 101u8, 95u8, 99u8, 97u8, 108u8, 108u8, 98u8, 97u8, 99u8, 107u8] =>
                {
                    ...
                    let mut ___cb_closure_loader___ =
                        CallDataArgLoader::new(___cb_data_deserializer___, self.error_api());
                    let caller: &Address = &dharitri_wasm::load_dyn_arg(
                        &mut ___cb_closure_loader___,
                        ArgId::from(&b"caller"[..]),
                    );
                    let result: AsyncCallResult<()> = dharitri_wasm::load_dyn_arg(
            ...
            match storage::EndpointWrappers::callback_selector(self, ___cb_data_deserializer___) {
                ...
                dharitri_wasm::types::CallbackSelectorResult::NotProcessed(recovered_deser) => {
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderDctModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
                name: "getFungibleDctBalance",
                only_owner: false,
                payable_in_tokens: &[],
                inputs: Vec::new(),
                outputs: Vec::new(),
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized + storage::ProxyTrait {
        #[allow(clippy::too_many_arguments)]
        fn get_fungible_dct_balance(
            self,
            token_identifier: &TokenIdentifier,
        ) -> dharitri_wasm::types::ContractCall<
            Self::SendApi,
            <Self::BigUint as dharitri_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"getFungibleDctBalance"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"send_dct"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"send_dct_twice"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                issue_cost,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"issue_fungible_token"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_display_name,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"local_mint"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"local_burn"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
    ...
    pub trait CallbackProxy: dharitri_wasm::api::CallbackProxyObjApi + Sized {
        fn dct_issue_callback(self, caller: &Address) -> dharitri_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = dharitri_wasm::types::ArgBuffer::new();
            dharitri_wasm::io::serialize_contract_call_arg(
                caller,
...
mod nft {
    ...
    impl dharitri_codec::TopEncode for Color {
        fn top_encode<O: dharitri_codec::TopEncodeOutput>(
            &self,
            output: O,
        ) -> core::result::Result<(), dharitri_codec::EncodeError> {
            let mut buffer = dharitri_codec::Vec::<u8>::new();
            let dest = &mut buffer;
            dharitri_codec::NestedEncode::dep_encode(&self.r, dest)?;
            dharitri_codec::NestedEncode::dep_encode(&self.g, dest)?;
            dharitri_codec::NestedEncode::dep_encode(&self.b, dest)?;
            output.set_slice_u8(&buffer[..]);
            core::result::Result::Ok(())
        }
        fn top_encode_or_exit<O: dharitri_codec::TopEncodeOutput, ExitCtx: Clone>(
            ...
            let mut buffer = dharitri_codec::Vec::<u8>::new();
            let dest = &mut buffer;
            dharitri_codec::NestedEncode::dep_encode_or_exit(&self.r, dest, c.clone(), exit);
            dharitri_codec::NestedEncode::dep_encode_or_exit(&self.g, dest, c.clone(), exit);
            dharitri_codec::NestedEncode::dep_encode_or_exit(&self.b, dest, c.clone(), exit);
            output.set_slice_u8(&buffer[..]);
        }
    }
    impl dharitri_codec::TopDecode for Color {
        fn top_decode<I: dharitri_codec::TopDecodeInput>(
            top_input: I,
        ) -> core::result::Result<Self, dharitri_codec::DecodeError> {
            let bytes = top_input.into_boxed_slice_u8();
            let input = &mut &*bytes;
            let result = Color {
                r: <u8 as dharitri_codec::NestedDecode>::dep_decode(input)?,
                g: <u8 as dharitri_codec::NestedDecode>::dep_decode(input)?,
                b: <u8 as dharitri_codec::NestedDecode>::dep_decode(input)?,
            };
            if !input.is_empty() {
                return core::result::Result::Err(dharitri_codec::DecodeError::INPUT_TOO_LONG);
            }
        ...
        fn top_decode_or_exit<I: dharitri_codec::TopDecodeInput, ExitCtx: Clone>(
            ...
            let input = &mut &*bytes;
            let result = Color {
                r: <u8 as dharitri_codec::NestedDecode>::dep_decode_or_exit(input, c.clone(), exit),
                g: <u8 as dharitri_codec::NestedDecode>::dep_decode_or_exit(input, c.clone(), exit),
                b: <u8 as dharitri_codec::NestedDecode>::dep_decode_or_exit(input, c.clone(), exit),
            };
            if !input.is_empty() {
                exit(c, dharitri_codec::DecodeError::INPUT_TOO_LONG);
            }
    ...
    impl dharitri_wasm::abi::TypeAbi for Color {
        fn type_name() -> dharitri_wasm::String {
            "Color".into()
        }
        fn provide_type_descriptions<TDC: dharitri_wasm::abi::TypeDescriptionContainer>(
    ...
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + ForwarderNftModule + storage::EndpointWrappers
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_get_nft_balance(&self) {
            ...
            let nonce = dharitri_wasm::load_single_arg::<Self::ArgumentApi, u64>(
                self.argument_api(),
                1i32,
                ArgId::from(&b"nonce"[..]),
            );
        ...
        fn call_buy_nft(&self) {
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
            let nft_id = dharitri_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"nft_id"[..]),
            );
            let nft_nonce = dharitri_wasm::load_single_arg::<Self::ArgumentApi, u64>(
                self.argument_api(),
                1i32,
                ArgId::from(&b"nft_nonce"[..]),
            );
            let nft_amount = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Self::BigUint>(
                self.argument_api(),
                2i32,
        ...
        fn call_nft_create(&self) {
            self.call_value().check_not_payable();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 7i32);
            let token_identifier = dharitri_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"token_identifier"[..]),
            ...
            let name = dharitri_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                2i32,
                ArgId::from(&b"name"[..]),
            );
            let royalties = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Self::BigUint>(
                self.argument_api(),
                3i32,
                ArgId::from(&b"royalties"[..]),
            );
            let hash = dharitri_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                4i32,
                ArgId::from(&b"hash"[..]),
            );
            let color = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Color>(
                self.argument_api(),
                5i32,
                ArgId::from(&b"color"[..]),
            );
            let uri = dharitri_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                6i32,
                ArgId::from(&b"uri"[..]),
            );
        ...
        fn call_transfer_nft_via_async_call(&self) {
            self.call_value().check_not_payable();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 5i32);
            let to = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
            ...
            let data = dharitri_wasm::load_single_arg::<Self::ArgumentApi, BoxedBytes>(
                self.argument_api(),
                4i32,
                ArgId::from(&b"data"[..]),
            );
        ...
        fn call_transfer_nft_and_execute(&self) {
            ...
            let nonce: u64 =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"nonce"[..]));
            let amount: Self::BigUint =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"amount"[..]));
            let function: BoxedBytes =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"function"[..]));
            let arguments: VarArgs<BoxedBytes> =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"arguments"[..]));
            ___arg_loader.assert_no_more_args();
        ...
        fn call_create_and_send(&self) {
            self.call_value().check_not_payable();
            dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 8i32);
            let to = dharitri_wasm::load_single_arg::<Self::ArgumentApi, Address>(
                self.argument_api(),
                0i32,
                ArgId::from(&b"to"[..]),
        ...
        fn callback_selector<'a>(
            ...
            match ___cb_data_deserializer___.get_func_name() {
                ...
                [110u8, 102u8, 116u8, 95u8, 105u8, 115u8, 115u8, 117u8, 101u8, 95u8, 99u8, 97u8, 108u8, 108u8, 98u8, 97u8, 99u8, 107u8] =>
                {
                    ...
                    let result: AsyncCallResult<TokenIdentifier> = dharitri_wasm::load_dyn_arg(
                        &mut ___call_result_loader___,
                        ArgId::from(&b"result"[..]),
                    );
                    ___cb_closure_loader___.assert_no_more_args();
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderNftModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized + storage::ProxyTrait {
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"get_nft_balance"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"buy_nft"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                nft_id,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                issue_cost,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"nft_issue"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_display_name,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        fn nft_create(
            ...
            Self::SendApi,
            <u64 as dharitri_wasm::io::EndpointResult>::DecodeAs,
        > {
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"nft_create"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"nft_add_quantity"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"nft_burn"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_identifier,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"transfer_nft_via_async_call"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"transfer_nft_and_execute"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"create_and_send"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                to,
                ___contract_call___.get_mut_arg_buffer(),
    ...
    pub trait CallbackProxy: dharitri_wasm::api::CallbackProxyObjApi + Sized {
        fn nft_issue_callback(self, caller: &Address) -> dharitri_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = dharitri_wasm::types::ArgBuffer::new();
            dharitri_wasm::io::serialize_contract_call_arg(
                caller,
...
mod roles {
    ...
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + ForwarderRolesModule + storage::EndpointWrappers
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
    {
        ...
        fn call_set_local_roles(&self) {
            ...
            let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
            let address: Address =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"address"[..]));
            let token_identifier: TokenIdentifier = dharitri_wasm::load_dyn_arg(
                &mut ___arg_loader,
                ArgId::from(&b"token_identifier"[..]),
            );
            let roles: VarArgs<DctLocalRole> =
                dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"roles"[..]));
            ___arg_loader.assert_no_more_args();
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderRolesModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
                name: "setLocalRoles",
                only_owner: false,
            ...
            endpoint_abi.add_input::<TokenIdentifier>("token_identifier");
            contract_abi.add_type_descriptions::<TokenIdentifier>();
            endpoint_abi.add_input::<VarArgs<DctLocalRole>>("roles");
            contract_abi.add_type_descriptions::<VarArgs<DctLocalRole>>();
            endpoint_abi.add_output::<AsyncCall<Self::SendApi>>(&[]);
            contract_abi.add_type_descriptions::<AsyncCall<Self::SendApi>>();
            contract_abi.endpoints.push(endpoint_abi);
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized + storage::ProxyTrait {
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"setLocalRoles"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                address,
                ___contract_call___.get_mut_arg_buffer(),
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"unsetLocalRoles"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                address,
                ___contract_call___.get_mut_arg_buffer(),
    ...
    pub trait CallbackProxy: dharitri_wasm::api::CallbackProxyObjApi + Sized {
        fn change_roles_callback(self) -> dharitri_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = dharitri_wasm::types::ArgBuffer::new();
            dharitri_wasm::types::CallbackCall::from_arg_buffer(
...
mod sft {
    ...
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + ForwarderSftModule + storage::EndpointWrappers
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderSftModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
                name: "sft_issue",
                only_owner: false,
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized + storage::ProxyTrait {
        ...
        > {
            ...
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ...
                issue_cost,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"sft_issue"[..]),
            );
            dharitri_wasm::io::serialize_contract_call_arg(
                token_display_name,
                ___contract_call___.get_mut_arg_buffer(),
    ...
    pub trait CallbackProxy: dharitri_wasm::api::CallbackProxyObjApi + Sized {
        fn sft_issue_callback(self, caller: &Address) -> dharitri_wasm::types::CallbackCall {
            let ___api___ = self.into_api();
            let mut ___closure_arg_buffer___ = dharitri_wasm::types::ArgBuffer::new();
            dharitri_wasm::io::serialize_contract_call_arg(
                caller,
...
mod storage {
    ...
    use dharitri_wasm::{non_zero_usize, only_owner, require, sc_error};
    use dharitri_wasm::{Box, Vec};
    pub trait ForwarderStorageModule: dharitri_wasm::api::ContractBase + Sized
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
        ...
        C: AutoImpl,
    {
        fn last_issued_token(&self) -> SingleValueMapper<Self::Storage, TokenIdentifier> {
            ...
            < SingleValueMapper < Self :: Storage , TokenIdentifier > as dharitri_wasm :: storage :: mappers :: StorageMapper < Self :: Storage > > :: new (self . get_storage_raw () , dharitri_wasm :: types :: BoxedBytes :: from (key))
        }
        fn last_error_message(&self) -> SingleValueMapper<Self::Storage, BoxedBytes> {
            let key: &'static [u8] = b"lastErrorMessage";
            < SingleValueMapper < Self :: Storage , BoxedBytes > as dharitri_wasm :: storage :: mappers :: StorageMapper < Self :: Storage > > :: new (self . get_storage_raw () , dharitri_wasm :: types :: BoxedBytes :: from (key))
        }
    }
    pub trait EndpointWrappers:
        dharitri_wasm::api::ContractPrivateApi + ForwarderStorageModule
    where
        Self::BigUint: dharitri_wasm::api::BigUintApi,
        for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
        for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
    ...
    impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
        ...
        type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
        fn abi() -> dharitri_wasm::abi::ContractAbi {
            let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & [] , name : "ForwarderStorageModule" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
            let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
                docs: &[],
    ...
    pub trait ProxyTrait: dharitri_wasm::api::ProxyObjApi + Sized {
        #[allow(clippy::too_many_arguments)]        fn last_issued_token (self) -> dharitri_wasm :: types :: ContractCall < Self :: SendApi , < SingleValueMapper < Self :: Storage , TokenIdentifier > as dharitri_wasm :: io :: EndpointResult > :: DecodeAs >{
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ___api___.clone(),
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"lastIssuedToken"[..]),
            );
            ___contract_call___
        }
        #[allow(clippy::too_many_arguments)]        fn last_error_message (self) -> dharitri_wasm :: types :: ContractCall < Self :: SendApi , < SingleValueMapper < Self :: Storage , BoxedBytes > as dharitri_wasm :: io :: EndpointResult > :: DecodeAs >{
            let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
                self.into_fields();
            let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
                ___api___.clone(),
                ...
                ___payment___,
                ___nonce___,
                dharitri_wasm::types::BoxedBytes::from(&b"lastErrorMessage"[..]),
            );
            ___contract_call___
        }
    }
...
pub trait Forwarder:
    dharitri_wasm::api::ContractBase
    + Sized
...
{
    fn init(&self) {}
    fn send_moax(&self, to: &Address, amount: &Self::BigUint, opt_data: OptionalArg<BoxedBytes>) {
        let data = match &opt_data {
            OptionalArg::Some(data) => data.as_slice(),
            OptionalArg::None => &[],
        };
    ...
    fn accept_moax_transfer_nft(
        ...
        if (!(nft_amount != 0)) {
            return dharitri_wasm::types::SCResult::Err(dharitri_wasm::types::SCError::from(
                "Cannot transfer zero amount",
            ))
            .into();
        };
        SCResult::from_result(self.send().direct_dct_nft_execute(
            &self.blockchain().get_caller(),
            &nft_id,
            nft_nonce,
            &nft_amount,
    ...
    fn accept_anything_transfer_nft(
        ...
        let balance = self.blockchain().get_dct_balance(
            &self.blockchain().get_sc_address(),
            &nft_id,
            nft_nonce,
        );
    ...
    fn accept_moax_check_annotations_call_value(
        &self,
        ...
        let (call_value_payment_amount, call_value_payment_token) =
            self.call_value().payment_token_pair();
        let call_value_payment_nonce = self.call_value().dct_token_nonce();
        if (!(call_value_payment_token == TokenIdentifier::moax())) {
            return dharitri_wasm::types::SCResult::Err(dharitri_wasm::types::SCError::from(
                "Call value payment token is not MOAX",
            ))
            .into();
        };
        if (!(annotation_payment_token == TokenIdentifier::moax())) {
            return dharitri_wasm::types::SCResult::Err(dharitri_wasm::types::SCError::from(
                "Annotation payment token is not MOAX",
            ))
            .into();
        };
...
pub trait EndpointWrappers:
    dharitri_wasm::api::ContractPrivateApi
    + Forwarder
    ...
    for<'b> Self::BigInt: core::ops::RemAssign<&'b Self::BigInt>,
{
    ...
    #[inline]
    fn call_send_moax(&self) {
        self.call_value().check_not_payable();
        let mut ___arg_loader = EndpointDynArgLoader::new(self.argument_api());
        let to: &Address = &dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"to"[..]));
        let amount: &Self::BigUint =
            &dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"amount"[..]));
        let opt_data: OptionalArg<BoxedBytes> =
            dharitri_wasm::load_dyn_arg(&mut ___arg_loader, ArgId::from(&b"opt_data"[..]));
        ___arg_loader.assert_no_more_args();
        self.send_moax(&to, &amount, opt_data);
    }
    #[inline]
    fn call_accept_moax_transfer_nft(&self) {
        let _ = self.call_value().require_moax();
        dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
        let nft_id = dharitri_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
            self.argument_api(),
            0i32,
        ...
        let result = self.accept_moax_transfer_nft(nft_id, nft_nonce, nft_amount);
        dharitri_wasm::io::EndpointResult::finish(&result, self.finish_api());
    }
    #[inline]
    ...
    fn call_accept_anything_with_payable_annotations_transfer_nft(&self) {
        ...
        let _payment_nonce = self.call_value().dct_token_nonce();
        dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 3i32);
        let nft_id = dharitri_wasm::load_single_arg::<Self::ArgumentApi, TokenIdentifier>(
            self.argument_api(),
            0i32,
    ...
    #[inline]
    fn call_accept_moax_check_annotations_call_value(&self) {
        let annotation_payment_amount = self.call_value().require_moax();
        let annotation_payment_token = TokenIdentifier::moax();
        let annotation_payment_nonce = 0u64;
        dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 0i32);
        let result = self.accept_moax_check_annotations_call_value(
    ...
    fn call_accept_anything_check_annotations_call_value(&self) {
        let (annotation_payment_amount, annotation_payment_token) =
            self.call_value().payment_token_pair();
        let annotation_payment_nonce = self.call_value().dct_token_nonce();
        dharitri_wasm::api::EndpointArgumentApi::check_num_arguments(&self.argument_api(), 0i32);
    ...
    fn call(&self, fn_name: &[u8]) -> bool {
        if match fn_name {
            ...
            {
                self.call_accept_moax_transfer_nft();
                true
            }
            ...
            {
                self.call_accept_moax_check_annotations_call_value();
                true
            }
        ...
        if dct::EndpointWrappers::call(self, fn_name) {
            return true;
        }
    ...
    fn callback_selector<'a>(
        ...
        match dct::EndpointWrappers::callback_selector(self, ___cb_data_deserializer___) {
            dharitri_wasm::types::CallbackSelectorResult::Processed => {
                return dharitri_wasm::types::CallbackSelectorResult::Processed;
            }
            dharitri_wasm::types::CallbackSelectorResult::NotProcessed(recovered_deser) => {
    ...
    fn callback(&self) {
        ...
        let mut ___cb_data_deserializer___ =
            dharitri_wasm::hex_call_data::HexCallDataDeserializer::new(___cb_data_raw___.as_slice());
        if let dharitri_wasm::types::CallbackSelectorResult::NotProcessed(_) =
            self::EndpointWrappers::callback_selector(self, ___cb_data_deserializer___)
        {
            self.error_api().signal_error(err_msg::CALLBACK_BAD_FUNC);
...
impl dharitri_wasm::api::ContractAbiProvider for AbiProvider {
    ...
    type SendApi = dharitri_wasm::api::uncallable::UncallableApi;
    fn abi() -> dharitri_wasm::abi::ContractAbi {
        let mut contract_abi = dharitri_wasm :: abi :: ContractAbi { docs : & ["Test contract for investigating contract calls."] , name : "Forwarder" , constructor : None , endpoints : Vec :: new () , type_descriptions : < dharitri_wasm :: abi :: TypeDescriptionContainerImpl as dharitri_wasm :: abi :: TypeDescriptionContainer > :: new () , } ;
        let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
            docs: &[],
            name: "init",
            only_owner: false,
        ...
        let mut endpoint_abi = dharitri_wasm::abi::EndpointAbi {
            docs: &[],
            name: "accept_moax_check_annotations_call_value",
            only_owner: false,
            payable_in_tokens: &["MOAX"],
            inputs: Vec::new(),
            outputs: Vec::new(),
        ...
        contract_abi.endpoints.push(endpoint_abi);
        contract_abi
            .coalesce(<call_sync::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi());
        contract_abi
            .coalesce(<call_async::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi());
        contract_abi.coalesce(
            <call_transf_exec::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi(),
        );
        contract_abi.coalesce(
            <contract_change_owner::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi(),
        );
        contract_abi.coalesce(
            <contract_deploy::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi(),
        );
        contract_abi.coalesce(
            <contract_update::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi(),
        );
        contract_abi.coalesce(<dct::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi());
        contract_abi.coalesce(<sft::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi());
        contract_abi.coalesce(<nft::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi());
        contract_abi.coalesce(<roles::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi());
        contract_abi
            .coalesce(<storage::AbiProvider as dharitri_wasm::api::ContractAbiProvider>::abi());
        contract_abi
    }
}
pub struct ContractObj<A: dharitri_wasm::api::ContractBase> {
...
impl<A> dct::AutoImpl for ContractObj<A> where
    A: dharitri_wasm::api::ContractBase
        + dharitri_wasm::api::ErrorApi
        + dharitri_wasm::api::EndpointArgumentApi
        + dharitri_wasm::api::EndpointFinishApi
...
impl<A> dct::EndpointWrappers for ContractObj<A>
where
    Self::BigUint: dharitri_wasm::api::BigUintApi,
    for<'a, 'b> &'a Self::BigUint: core::ops::Add<&'b Self::BigUint, Output = Self::BigUint>,
    for<'a, 'b> &'a Self::BigUint: core::ops::Sub<&'b Self::BigUint, Output = Self::BigUint>,
...
{
    #[allow(clippy::too_many_arguments)]
    fn init(self) -> dharitri_wasm::types::ContractDeploy<Self::SendApi> {
        let (___api___, _, _, ___payment___, _) = self.into_fields();
        let mut ___contract_deploy___ =
            dharitri_wasm::types::new_contract_deploy(___api___.clone(), ___payment___);
    ...
    > {
        ...
        let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
            ...
            ___payment___,
            ___nonce___,
            dharitri_wasm::types::BoxedBytes::from(&b"send_moax"[..]),
        );
        dharitri_wasm::io::serialize_contract_call_arg(
            to,
            ___contract_call___.get_mut_arg_buffer(),
    ...
    fn accept_moax_transfer_nft(
        ...
        Self::SendApi,
        <SCResult<()> as dharitri_wasm::io::EndpointResult>::DecodeAs,
    > {
        let (___api___, ___address___, ___token___, ___payment___, ___nonce___) =
            self.into_fields();
        let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
            ...
            ___payment___,
            ___nonce___,
            dharitri_wasm::types::BoxedBytes::from(&b"accept_moax_transfer_nft"[..]),
        );
        dharitri_wasm::io::serialize_contract_call_arg(
            nft_id,
            ___contract_call___.get_mut_arg_buffer(),
    ...
    > {
        ...
        let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
            ...
            ___payment___,
            ___nonce___,
            dharitri_wasm::types::BoxedBytes::from(&b"accept_anything_transfer_nft"[..]),
        );
        dharitri_wasm::io::serialize_contract_call_arg(
            nft_id,
            ___contract_call___.get_mut_arg_buffer(),
    ...
    > {
        ...
        let mut ___contract_call___ = dharitri_wasm::types::new_contract_call(
            ...
            annotation_payment_amount,
            annotation_payment_nonce,
            dharitri_wasm::types::BoxedBytes::from(&b"accept_moax_check_annotations_call_value"[..]),
        );
        ___contract_call___
    }
    #[allow(clippy::too_many_arguments)]
...
impl<SA> call_sync::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> call_async::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> call_transf_exec::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> contract_change_owner::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> contract_deploy::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> contract_update::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> dct::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> sft::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> nft::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> roles::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
impl<SA> storage::ProxyTrait for Proxy<SA> where SA: dharitri_wasm::api::SendApi {}
